How many times it has happened to you that after making a project when it comes to uploading it on a platform you have to make a readme.md file and you are stuck making or figuring out which badges to use and how to make your readme file aesthetic .I understand your pain Here's end to all that sufferings. I have created a list of most used/important/popular Badges for u to use in your GitHub Profile/Project. And that's no it the badges will be updated in frequent time intervals for new badges as per their popularity.

Please Give ❤️ and add to your 🔖s . Also share 🔗/s with your friends if you like it.

{% embed https://github.com/Envoy-VC/awesome-badges noreadme %}
